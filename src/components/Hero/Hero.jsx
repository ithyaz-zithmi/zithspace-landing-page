      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <h1 className={styles.title}>
            ...
            {/* Floating Labels */}
            <div className={`${styles.floatingLabel} ${styles.leftLabel}`}>
              SaaS Company
            </div>
            ...
            <div className={`${styles.floatingLabel} ${styles.rightLabel}`}>
              Product Company
            </div>

            <div className={styles.sendb}>
              <img src={sendb} alt='icon1'/>
            </div>
